...
plugins=(git git-extra git-flow mercurial dnf docker vundle man colored-man-pages colorize extract taskwarrior rsync ant mvn bgnotify systemadmin encode64 zsh-navigation-tools emoji-clock gradle rand-quote)
